...
typedef enum {
    ...
    WSConnectionTypeCreatelist,
    WSConnectionTypeAddItemToList,
    WSConnectionTypeAddItemToShoppingCart,
    WSConnectionTypeGetListByID,
    WSConnectionTypeSaveList,
    WSConnectionTypeConvertCartToList,
    WSconnectionTypeConvertListToCart,
    WSConnectionTypeGetListByUser,
    WSConnectionTypeGetPurchaseHistoryByUser,
    WSConnectionTypeGetShoppingCart,
    WSConnectionTypeDeleteTicketList,
    WSConnectionTypeCreateUser,
    WSConnectionTypeSendTicketByEmail,
    WSConnectionTypeDeleteItem,
    WSConnectionTypeDeleteItemFromShoppingCart,
    WSConnectionTypeUpdateItemByItem,
    WSConnectionTypeUpdateShoppingCartItem,
    WSConnectionTypeUpdateTicketList,
    WSConnectionTypeUpdateUserAddress,
    WSConnectionTypeUpdateUserProfile,
    WSConnectionTypeGetAddressByID,
    WSConnectionTypeSendOrderByEmail,
    WSConnectionTypeGetCategoriesList,
    WSConnectionTypeGetItemsBySearching,
    WSConnectionTypeGetItemByUPC,
    WSConnectionTypeGetItemsByTicket,
    WSConnectionTypeGetDeliveryHours,
    WSConnectionTypeGetDeliveryTypes,
    ...
    WSConnectionTypePaymentTypeCatalog,
    WSConnectionTypeDeliveryTypeCatalog,
